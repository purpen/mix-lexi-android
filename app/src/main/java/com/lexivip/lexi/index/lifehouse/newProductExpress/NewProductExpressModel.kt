...
open class NewProductExpressModel {
    ...
    fun loadData(page: Int, sortType: String, minePrice: String, maxPrice: String, cids: String,is_free_postage: String, is_preferential: String,is_custom_made: String,sort_newest:String,callBack: IDataSource.HttpRequestCallBack) {
        ...
        val params = ClientParamsAPI.getNewProductExpressParams(page, sortType,minePrice, maxPrice, cids,is_free_postage,is_preferential,is_custom_made,sort_newest)

        HttpRequest.sendRequest(HttpRequest.GET, URL.NEW_GOODS_EXPRESS, params, object : IDataSource.HttpRequestCallBack {
