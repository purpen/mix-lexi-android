package com.lexivip.lexi.index.explore.goodDesign
...
class DialogBottomSynthesiseSort(context: FragmentActivity?, presenter: AllGoodDesignPresenter) : BottomBaseDialog<DialogBottomSynthesiseSort>(context) {
    private lateinit var view: View
    private val present: AllGoodDesignPresenter = presenter
    ...
    private fun setSelection(sortType:String){
        ...
        when (sortType) {
            AllGoodDesignPresenter.SORT_TYPE_SYNTHESISE -> {
            ...
            AllGoodDesignPresenter.SORT_TYPE_LOW_UP -> {
            ...
            AllGoodDesignPresenter.SORT_TYPE_UP_LOW -> {
    ...
    override fun setUiBeforShow() {
        ...
        view.textViewSynthesis.setOnClickListener {
            setSelection(AllGoodDesignPresenter.SORT_TYPE_SYNTHESISE)
            val page = 1
            val minPrice = ""
            val maxPrice = ""
            val cids = ""
            present.loadData(page, AllGoodDesignPresenter.SORT_TYPE_SYNTHESISE, minPrice, maxPrice,cids,"","","","")
            dismiss()
        }

        //价格由低到高
        view.textViewLow2Up.setOnClickListener {
            setSelection(AllGoodDesignPresenter.SORT_TYPE_LOW_UP)
            val page = 1
            val minPrice = ""
            val maxPrice = ""
            val cids = ""
            present.loadData(page, AllGoodDesignPresenter.SORT_TYPE_LOW_UP, minPrice, maxPrice,cids,"","","","")
            dismiss()
        }

        //价格由高到低
        view.textViewUp2Low.setOnClickListener {
            setSelection(AllGoodDesignPresenter.SORT_TYPE_UP_LOW)
            val page = 1
            val minPrice = ""
            val maxPrice = ""
            val cids = ""
            present.loadData(page, AllGoodDesignPresenter.SORT_TYPE_UP_LOW, minPrice, maxPrice,cids,"","","","")
            dismiss()
        }
    }
}