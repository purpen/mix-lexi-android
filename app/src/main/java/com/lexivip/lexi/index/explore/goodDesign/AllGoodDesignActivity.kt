...
class AllGoodDesignActivity : BaseActivity(), AllGoodDesignContract.View {
        ...
        linearLayoutSort.setOnClickListener { _ ->
            ...
            dialog.setOnDismissListener {
                ...
                when (presenter.getSortType()) {
                    ...
                    AllGoodDesignPresenter.SORT_TYPE_LOW_UP -> textViewSort.text = Util.getString(R.string.text_price_low_up)
