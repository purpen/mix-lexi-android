...
class NewGoodsExpressAdapter(layoutResId: Int) : BaseQuickAdapter<ProductBean, BaseViewHolder>(layoutResId) {
    private val pixelSize: Int by lazy { DimenUtil.dp2px(140.0) }
