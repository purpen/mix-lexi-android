...
public class ReceiveVoucherRecommendModel {
    ...
    public void  loadBrandRecommend(String store_category, final IDataSource.HttpRequestCallBack callBack){
        HashMap<String,Object> params=ClientParamsAPI.getVoucherBrandParams(store_category);
        HttpRequest.sendRequest(HttpRequest.GET, URL.VOUCHER_SHARE, params, new IDataSource.HttpRequestCallBack() {
            @Override
            public void onSuccess(@NotNull Bitmap json) {
    ...
    public void loadTypeOfficical(String category_id,final IDataSource.HttpRequestCallBack callBack){
        HashMap<String, Object> params=ClientParamsAPI.getOffici(category_id);
        HttpRequest.sendRequest(HttpRequest.GET, URL.VOUCHER_RECOMMEND, params, new IDataSource.HttpRequestCallBack() {
            @Override
            public void onSuccess(@NotNull Bitmap json) {
