...
public class AdapterReceiveVoucherOfficialType extends BaseQuickAdapter<VoucherOfficialBean.DataBean.OfficialCouponsBean,BaseViewHolder> {
    public AdapterReceiveVoucherOfficialType(int layoutResId) {
        super(layoutResId);
    }
