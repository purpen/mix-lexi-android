...
class ShopCartActivity : BaseActivity(), ShopCartContract.View {
    ...
    private fun iniShopCart() {
        val headerView = LayoutInflater.from(this).inflate(R.layout.header_shop_cart_goods, null)
        ...
        //编辑状态购物车
        val editShopCartEmpty = View.inflate(this, R.layout.header_empty_shop_cart, null)
        val linearLayoutManagerEdit = LinearLayoutManager(this)
    ...
    override fun installListener() {
        ...
        adapterOrder.setOnItemChildClickListener { adapter, view, position ->
            when (view.id) {
                R.id.textViewReselectSpec -> { //重新选择规格
                    ...
                    val addShopCartBottomDialog = ShopCartReselectSKUBottomDialog(this, presenter, itemBean.product)
        ...
        adapterWish.setOnItemChildClickListener { adapter, view, position ->
            val productBean = adapter.getItem(position) as ProductBean
            val addShopCartBottomDialog = AddShopCartBottomDialog(this, presenter, productBean)
            addShopCartBottomDialog.show()
        }
    ...
    private fun clickedSettleAccount() {
        ...
        //结算
        val intent = Intent(this, SelectExpressAddressActivity::class.java)
    ...
    override fun setNewData(products: MutableList<ProductBean>) {
        if (products.isEmpty()) {
            ...
            adapterWish.removeHeaderView(headerViewWishOrder)
            headerViewWishOrder = View.inflate(this, R.layout.header_shop_cart_wish_order, null)
