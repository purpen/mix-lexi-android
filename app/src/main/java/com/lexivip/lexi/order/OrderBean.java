...
public class OrderBean {
    ...
    public int status;
    public OrderListBean.DataBean.OrdersBean.StoreBean store;
    ...
    public List<OrderListBean.DataBean.OrdersBean.ItemsBean> items;
    ...
    public static class StoreBean {
        ...
        public OrderListBean.DataBean.OrdersBean.StoreBean.StoreLogoBean store_logo;
