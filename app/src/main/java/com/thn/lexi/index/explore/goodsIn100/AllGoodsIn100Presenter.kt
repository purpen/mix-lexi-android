...
class AllGoodsIn100Presenter(view: AllGoodIn100Contract.View) : AllGoodIn100Contract.Presenter {
    private var view: AllGoodIn100Contract.View = checkNotNull(view)

    private val dataSource: AllGoodsIn100Model by lazy { AllGoodsIn100Model() }
