...
class AllGoodsSelectionPresenter(view: AllGoodsSelectionContract.View) : AllGoodsSelectionContract.Presenter {
    private var view: AllGoodsSelectionContract.View = checkNotNull(view)
