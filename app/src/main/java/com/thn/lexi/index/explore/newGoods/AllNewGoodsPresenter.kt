...
import com.thn.lexi.index.lifehouse.LookPeopleBean
import java.io.IOException

class AllNewGoodsPresenter(view: AllNewGoodsContract.View) : AllNewGoodsContract.Presenter {
    private var view: AllNewGoodsContract.View = checkNotNull(view)

    private val dataSource: AllNewGoodsModel by lazy { AllNewGoodsModel() }
