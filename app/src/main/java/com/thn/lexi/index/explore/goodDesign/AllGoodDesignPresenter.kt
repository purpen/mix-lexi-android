...
class AllGoodDesignPresenter(view: AllGoodDesignContract.View) : AllGoodDesignContract.Presenter {
    private var view: AllGoodDesignContract.View = checkNotNull(view)

    private val dataSource: AllGoodDesignModel by lazy { AllGoodDesignModel() }
