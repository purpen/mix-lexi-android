...
class AllLikeGoodsPresenter(view: AllLikeGoodsContract.View) : AllLikeGoodsContract.Presenter {
    private var view: AllLikeGoodsContract.View = checkNotNull(view)

    private val dataSource: AllLikeGoodsModel by lazy { AllLikeGoodsModel() }
