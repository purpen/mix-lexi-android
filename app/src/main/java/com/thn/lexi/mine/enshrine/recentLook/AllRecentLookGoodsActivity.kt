...
class AllRecentLookGoodsActivity : BaseActivity(), AllRecentLookGoodsContract.View {
        ...
        linearLayoutSort.setOnClickListener { _ ->
            ...
            dialog.setOnDismissListener {
                ...
                when (presenter.getSortType()) {
                    AllRecentLookGoodsPresenter.SORT_TYPE_SYNTHESISE -> textViewSort.text = Util.getString(R.string.text_sort_synthesize)
                    AllRecentLookGoodsPresenter.SORT_TYPE_LOW_UP -> textViewSort.text = Util.getString(R.string.text_price_low_up)
                    AllRecentLookGoodsPresenter.SORT_TYPE_UP_LOW -> textViewSort.text = Util.getString(R.string.text_price_up_low)
                }
            }
            dialog.show()
        }
