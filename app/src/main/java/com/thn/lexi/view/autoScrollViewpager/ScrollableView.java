...
public class ScrollableView extends RelativeLayout {
    ...
    private void initView() {
        View view = LayoutInflater.from(context).inflate(R.layout.view_auto_scroll_viewpager, this);
        viewPager = (CustomAutoScrollViewPager) view.findViewById(R.id.customAutoScrollViewPager);
