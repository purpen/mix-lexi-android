...
import com.thn.lexi.album.ImageSelectActivity;
...
public class GridViewItemRelativeLayout extends RelativeLayout {
        ...
        this.imageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (GridViewItemRelativeLayout.this.mCollection.isSelected(item.buildContentUri())) {
                    ...
                    GridViewItemRelativeLayout.this.imageCheck.setImageResource(com.thn.imagealbum.R.drawable.pick_photo_checkbox_normal);
                    GridViewItemRelativeLayout.this.imageView.clearColorFilter();
                } else {
                    GridViewItemRelativeLayout.this.mCollection.add(item.buildContentUri());
                    GridViewItemRelativeLayout.this.imageCheck.setImageResource(com.thn.imagealbum.R.drawable.pick_photo_check);
    ...
    public void setItem(Picture item) {
        ...
        imageCheck.setImageResource(com.thn.imagealbum.R.drawable.pick_photo_checkbox_normal);
        if (mCollection.isSelected(item.buildContentUri())) {
            imageView.setColorFilter(Color.GRAY, PorterDuff.Mode.MULTIPLY);
            imageCheck.setImageResource(com.thn.imagealbum.R.drawable.pick_photo_check);
        }
