...
public class RecycleBin {
     ...
     * layout, and at the end of layout all view_selection_goods_center_recommend in activeViews are moved to scrapViews.
     * Views in activeViews represent a contiguous range of Views, with position of the first
     * view_selection_goods_center_recommend store in mFirstActivePosition.
     */
    private View[] activeViews = new View[0];
    private int[] activeViewTypes = new int[0];

    /** Unsorted views that can be used by the adapter as a convert view_selection_goods_center_recommend. */
    ...
    /** @return A view_selection_goods_center_recommend from the ScrapViews collection. These are unordered. */
    ...
    /**
     * Put a view_selection_goods_center_recommend into the ScrapViews list. These views are unordered.
     *
     * @param scrap The view_selection_goods_center_recommend to add
     */
    ...
    static View retrieveFromScrap(SparseArray<View> scrapViews, int position) {
        ...
        if (size > 0) {
            // See if we still have a view_selection_goods_center_recommend for this position.
