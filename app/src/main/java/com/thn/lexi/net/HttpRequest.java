...
public class HttpRequest {
     ...
     * @return call
     */
    public static Call getRequest(String requestUrl, IDataSource.HttpRequestCallBack callback) {
    ...
    public static Call getRequest(String requestUrl, String urlSuffix, HashMap params, IDataSource.HttpRequestCallBack callback) {
     ...
     * @return call
     */
    public static Call sendRequest(String type, String requestUrl, IDataSource.HttpRequestCallBack callback) {
        return sendRequest(type, requestUrl, null, ClientParamsAPI.getDefaultParams(), callback);
    }

    public static Call sendRequest(String type, String requestUrl, HashMap params, IDataSource.HttpRequestCallBack callback) {
        return sendRequest(type, requestUrl, null, params, callback);
    }

    public static Call sendRequest(String type, String requestUrl, String authorization, HashMap params, IDataSource.HttpRequestCallBack callback) {
